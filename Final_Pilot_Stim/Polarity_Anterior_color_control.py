...
# set dotSqr
def init_dot_stim(window,num_reps,field_size, n_dots,coher,field_shape, stim_name,sweep_params_exp_sqr, background_color=None):
...
# set constant circ 
def init_circle(window, r=20, repetitions=10, sweep_param = {}, background_color=None):
    circle = visual.ShapeStim(
        win, vertices= _calcEquilateralVertices(_calculateMinEdges(1.5, threshold=5)),
        pos=(0,-8), size=(r*2, r*2), units="deg",
        interpolate=True, fillColor=background_color,
        autoDraw=False, lineWidth=0, lineColor=background_color)
