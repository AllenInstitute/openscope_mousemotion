# -*- coding: utf-8 -*-
"""
Created on Tue Jun 11 14:49:46 2024
...
class Stimulus(EObject):
    ...
    def __init__(self,
        ...
        self.sweep_table_ready = sweep_table_ready
        self.stim_text = ""
        self.stim_path = ""
    ...
    def _build_sweep_table(self):
        ...
        if len[self.sweep_table_ready]>1:
            self.sweep_table =  self.sweep_table_ready
            self.sweep_order, self.dimnames = buildSweepTable(
